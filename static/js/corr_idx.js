...
async function initialze() {
    ...
    window.addEventListener("click", function () {if (contextMenuVisible) {$contextMenu.hide(); contextMenuVisible=false;} });
    ...
    cancelBtn.addEventListener('click', function () { countryCodeOfRow = -1; });
}
...
function showContextMenu(event) {
    ...
    countryCodeOfRow = event.target.parentElement.getElementsByTagName('td')[0].innerHTML;
